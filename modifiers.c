...
char    *make_mode_dio(char *str, va_list argptr, char type, int tol)
{
	...
	if ((type == 'd' && ft_strcmp(str, "hh") == 0) || (type == 'i' && ft_strcmp(str, "hh") == 0))
		res = ft_itoa((char)va_arg(argptr, int));
    if((type == 'd' && ft_strcmp(str, "h") == 0) || (type == 'i' && ft_strcmp(str, "h") == 0))
		res = ft_itoa((short)va_arg(argptr, unsigned int));
    if ((type == 'd' && ft_strcmp(str, "l") == 0) || (type == 'i' && ft_strcmp(str, "l") == 0))
		res = ft_itoa(va_arg(argptr, unsigned long int));
    if ((type == 'd' && ft_strcmp(str, "ll") == 0) || (type == 'i' && ft_strcmp(str, "ll") == 0))
...
char    *make_mode_uxXf(char *str, va_list argptr, char type, int tol)
{
	...
	if (str == NULL)
		res = find_type(type, argptr, tol);
	if ((type == 'u' && ft_strcmp(str, "ll") == 0)|| (type == 'u' && ft_strcmp(str, "l") == 0))
		res = ft_itoa((unsigned long long int)va_arg(argptr, long long int));
	if ((type == 'x' && ft_strcmp(str, "hh") == 0) || (type == 'X' && ft_strcmp(str, "hh") == 0))
		res = ft_itoa_base(va_arg(argptr, int), 16, type);
	if ((type == 'x' && ft_strcmp(str, "h") == 0) || (type == 'X' && ft_strcmp(str, "h") == 0))
		res = ft_itoa_base(va_arg(argptr, unsigned int), 16, type);
    if ((type == 'x' && ft_strcmp(str, "l") == 0) || (type == 'X' && ft_strcmp(str, "l") == 0))
		res = ft_itoa_base(va_arg(argptr, unsigned long int), 16, type);
	if ((type == 'x' && ft_strcmp(str, "ll") == 0) || (type == 'X' && ft_strcmp(str, "ll") == 0))
